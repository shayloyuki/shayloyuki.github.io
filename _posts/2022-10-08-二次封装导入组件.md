...
2. 轮询时机：
    ...
    **正确做法是：调用 `A` 接口的同时，就开始轮询 `B` 接口，一旦导入进度为 `100%` 就停止轮询，显示导入成功。**
    ...
    ![点击查看图片 https://img2022.cnblogs.com/blog/2399063/202209/2399063-20220902095818379-678630066.png](../assets/images/2022-10-08-er-ci-feng-zhuang-dao-ru-zu-jian/uploadFile.png)

    ![点击查看图片 https://img2022.cnblogs.com/blog/2399063/202209/2399063-20220902095900091-896148240.png](../assets/images/2022-10-08-er-ci-feng-zhuang-dao-ru-zu-jian/watch%20isUploading.png)

    ![点击查看图片 https://img2022.cnblogs.com/blog/2399063/202209/2399063-20220902095958901-803588697.png](../assets/images/2022-10-08-er-ci-feng-zhuang-dao-ru-zu-jian/loopProgress.png)

3. 坑：进度条不显示导入成功。
    >进度条等不到显示 `100% 导入成功`就会消失的原因是：之前在调用接口 `A` 成功后就设置 `isUploading = false`，而此时还在轮询接口 `B`，`percentage` 还不到100。
    
      ![点击查看图片 https://img2022.cnblogs.com/blog/2399063/202209/2399063-20220902100238400-1288645412.png](../assets/images/2022-10-08-er-ci-feng-zhuang-dao-ru-zu-jian/el-progress.png)

      **解决办法：在 `percentage` 达到100之后，再设置 `isUploading = false` 令进度条消失。**

      **注意：在让进度条消失之前，要先清除轮询定时器，并且过1秒钟再让进度条消失（这样会让完成画面定格在界面上一会儿，提示用户）。**

      ![点击查看图片 https://img2022.cnblogs.com/blog/2399063/202210/2399063-20221008152509411-851934737.png](../assets/images/2022-10-08-er-ci-feng-zhuang-dao-ru-zu-jian/watch%20percentage.png)
